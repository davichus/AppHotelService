...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $sql = "INSERT INTO Hotel
          (nombreHotel, descripcionHotel, correoHotel, direccionHotel, ubicacionHotel, telefonoHotel, estadoHotel)
          VALUES
          (:nombreHotel, :descripcionHotel, :correoHotel, :direccionHotel, :ubicacionHotel, :telefonoHotel, :estadoHotel)";
...
{
	$codigo = $_GET['idHotel'];
  $statement = $dbConn->prepare("DELETE FROM  Hotel where codigo=:codigo");
